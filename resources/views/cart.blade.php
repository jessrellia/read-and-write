...
<head>
    ...
    <style>
        ...
        .not-found{
           background-image: url('{{asset('others/cart-is-empty.png')}}');
           background-size: cover;
           position: absolute;
           top: 0;
           left: 0;
        ...
        @if (!$cart_details->isEmpty())
            ...
            <div class="card" >
                <div class="card-header">
                    <h5>Stationary Name : {{$products->name}}</h5>
                </div>
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <br>
                            <button type="button" class="btn btn-primary btn-sm mr-sm-2" onclick="window.location.href='/update-cart/{{$products->id}}'">Edit</button>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="/delete-cart/{{$products->id}}" method="post">
                                                {{csrf_field()}}
            ...
            <br>
            @endforeach
            <button type="button" class="btn btn-lg btn-danger" onclick="window.location.href='/checkout'">Check Out</button>
        @else
